...
import { ArrowLeft, RotateCcw, Package, Clock, AlertTriangle, CheckCircle, XCircle, CreditCard, Ban } from "lucide-react";
...
const CancellationRefundPolicy = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Cancellation & Refund Policy | Rayn Adam</title>
        <meta name="description" content="Cancellation and refund policy for Rayn Adam Luxury Perfumes. Learn about our cancellation terms, 7-day return window and refund process." />
      </Helmet>
      ...
      <main className="container mx-auto px-4 py-24">
        ...
        >
          ...
          <div className="max-w-4xl mx-auto">
            <h1 className="text-3xl md:text-4xl font-heading text-foreground mb-4">Cancellation & Refund Policy</h1>
            <p className="text-muted-foreground mb-12">Last updated: January 2026</p>

            {/* CANCELLATION SECTION */}
            <div className="mb-16">
              <h2 className="text-2xl md:text-3xl font-heading text-primary mb-8 pb-4 border-b border-border">Order Cancellation</h2>
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Cancellation Window</h3>
                </div>
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">How to Cancel Your Order</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Orders That Cannot Be Cancelled</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
            ...
            <div className="mb-16">
              <h2 className="text-2xl md:text-3xl font-heading text-primary mb-8 pb-4 border-b border-border">Returns & Refunds</h2>
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">7-Day Return Window</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <div className="flex items-start gap-3 p-4 bg-primary/5 border border-primary/20 rounded-lg mb-4">
                    <CheckCircle className="w-5 h-5 text-primary mt-0.5 flex-shrink-0" />
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Eligible for Return</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start gap-2">
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Not Eligible for Return</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <ul className="space-y-3 text-muted-foreground">
                    <li className="flex items-start gap-2">
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">How to Initiate a Return</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <ol className="space-y-4">
                    <li className="flex items-start gap-4">
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Refund Process</h3>
                </div>
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Non-Refundable Charges</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
              ...
              <section className="mb-12">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-heading text-foreground">Exchange Policy</h3>
                </div>
                <div className="bg-card border border-border rounded-xl p-6">
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
...
export default memo(CancellationRefundPolicy);
