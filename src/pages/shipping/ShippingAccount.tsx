...
const ShippingAccount = () => {
  ...
  const fetchAccountData = async () => {
    ...
    try {
      ...
      // Fetch staff info and stats
      const { data, error } = await supabase.functions.invoke("get-shipping-account", {
      ...
      if (data) {
        ...
        setOrderStats(data.stats || { pending: 0, processing: 0, shipped: 0, delivered: 0, total: 0 });
...
export default memo(ShippingAccount);
